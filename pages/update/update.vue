  ...
  <view class="content">
    <view class="summary-wrap">
       ...
       <view style="margin-top:10px; color:#1989fa;">
          ...
          <a v-if="wdszSaleChannel==='2'" :href="update.pkgUrl2"><text>点击下载辅助APP</text></a>
          <a v-if="wdszSaleChannel==='3'" :href="update.pkgUrl3"><text>点击下载辅助APP</text></a>
          <a v-if="wdszSaleChannel==='4'" :href="update.pkgUrl4"><text>点击下载辅助APP</text></a>
